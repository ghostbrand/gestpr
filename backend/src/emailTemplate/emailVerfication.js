  ...
  return `
    <div>
        ...
        <body data-id="__react-email-body">
            ...
            <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0">Recebemos um pedido para redefinir a palavra-passe da sua conta no GestPR. Clique no link abaixo para escolher uma nova palavra-passe:</p>
