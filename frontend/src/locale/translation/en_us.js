const lang = {
  ...
  mail_send_failed: 'Could not send email. Please try again.',
  no_line_items: 'No line items on this document.',
  ...
  search: 'search',
  service_catalog: 'Services & items',
  service_catalog_list: 'Service catalog',
  add_new_service_item: 'Add service / item',
  service_item: 'Service / item',
  service_item_name: 'Name',
  catalog_service: 'Catalog',
  catalog_pick_placeholder: 'Pick from catalog (optional)',
  dashboard_subtitle: 'Activity summary and quick access to recent invoices.',
  menu_group_main: 'Main',
  menu_group_billing: 'Billing',
  menu_group_reports: 'Reports',
  menu_group_settings: 'Setup',

  new_document: 'New',
  movements_report: 'Movements report',
  movements_report_subtitle:
    'Invoices, payments and quotes by period — view and export to PDF.',
  movements_period: 'Period',
  movements_period_daily: 'Day',
  movements_period_monthly: 'Month',
  movements_period_yearly: 'Year',
  movements_period_range: 'Date range',
  movements_month: 'Month',
  movements_year: 'Year',
  movements_date_range: 'Start and end dates',
  movements_apply: 'Apply',
  movements_export_pdf: 'Export PDF',
  movements_report_range_required: 'Please select start and end dates.',

  tax_rate_label: 'Tax rate',
  tax_rate_required: 'Please select a tax rate.',
  tax_rate_tooltip: 'Configured under Taxes. Applied on the subtotal.',

  menu_group_team: 'Team',
  admin_users_menu: 'Users',
  admin_users_title: 'Users',
  admin_users_subtitle: 'Accounts, roles and status. Only owner and manager can manage users.',
  ...
  role_staff: 'Staff — day-to-day work; no global settings',
  active: 'Active',
  inactive: 'Inactive',
  surname: 'Surname',
  ...
  yes: 'Yes',
  no: 'No',
  item_kind_label: 'Type',
  item_kind_help: 'Service: no stock. Article: stock and SKU for inventory.',
  item_kind_service: 'Service',
  item_kind_article: 'Article (stock)',
  item_kind_short: 'Type',
  tab_catalog_all: 'All',
  new_service: 'New service',
  new_article: 'New article',
  sku_label: 'SKU / code',
  sku_placeholder: 'Internal reference',
  stock_quantity: 'Stock',
  min_stock_level: 'Minimum stock',
  unit_label: 'Unit',
  article_stock_section: 'Inventory (articles only)',
};
