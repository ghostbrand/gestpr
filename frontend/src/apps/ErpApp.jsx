  ...
  if (settingIsloaded)
    return (
      <Layout hasSider className="erp-app-shell">
        ...
        {isMobile ? (
          <Layout className="erp-app-main" style={{ marginLeft: 0, minWidth: 0 }}>
            <HeaderContent />
            <Content
              className="app-shell-content app-shell-content--mobile"
              style={{ overflow: 'initial', width: '100%', minWidth: 0 }}
            >
              <AppRouter />
            </Content>
          </Layout>
        ) : (
          <Layout className="erp-app-main" style={{ minWidth: 0 }}>
            <HeaderContent />
            <Content
